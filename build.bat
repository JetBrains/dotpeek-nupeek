...
copy /y src\NuPeek\bin\Release\*.1.0.* install\NuPeek.1.0\
copy /y src\NuPeek\bin\Release\NuGet.Core.* install\NuPeek.1.0\
...
copy /y src\NuPeek\bin\Release\*.1.1.* install\NuPeek.1.1\
copy /y src\NuPeek\bin\Release\NuGet.Core.* install\NuPeek.1.1\