...
namespace JetBrains.DotPeek.Plugins.NuPeek.Infrastructure
{
    ...
    public sealed class CredentialsDialog
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:JetBrains.DotPeek.Plugins.NuPeek.Infrastructure.CredentialsDialog"/> class with the specified target.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:JetBrains.DotPeek.Plugins.NuPeek.Infrastructure.CredentialsDialog"/> class with the specified target and caption.
        /// </summary>
        /// <param name="target">The name of the target for the credentials, typically a server name.</param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:JetBrains.DotPeek.Plugins.NuPeek.Infrastructure.CredentialsDialog"/> class with the specified target, caption and message.
        /// </summary>
        /// <param name="target">The name of the target for the credentials, typically a server name.</param>
        /// <param name="caption">The caption of the dialog (null will cause a system default title to be used).</param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:JetBrains.DotPeek.Plugins.NuPeek.Infrastructure.CredentialsDialog"/> class with the specified target, caption, message and banner.
        /// </summary>
        /// <param name="target">The name of the target for the credentials, typically a server name.</param>
        /// <param name="caption">The caption of the dialog (null will cause a system default title to be used).</param>
        /// <param name="message">The message of the dialog (null will cause a system default message to be used).</param>
        ...
        public string Username
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    {
                        string message = String.Format(Thread.CurrentThread.CurrentUICulture, "The username has a maximum length of {0} characters.", CREDUI.MAX_USERNAME_LENGTH);
        ...
        {
            return Show(null, this.Username, this.Password, this.SaveChecked);
        }
        ...
        {
            return Show(null, this.Username, this.Password, saveChecked);
        }
        ...
        {
            return Show(owner, this.Username, this.Password, this.SaveChecked);
        }
        ...
        {
            return Show(owner, this.Username, this.Password, saveChecked);
        }
    ...
    public sealed class CREDUI
    {
        ...
        public static extern ReturnCodes PromptForCredentials(ref INFO creditUR, string targetName, IntPtr reserved1, int iError, StringBuilder userName, int maxUserName, StringBuilder password, int maxPassword, ref int iSave, FLAGS flags);
